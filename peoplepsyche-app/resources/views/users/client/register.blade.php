            ...
            <form id="register-form" class="row mb-4 g-3" method="POST" action="{{ route('register') }}">
                ...
                <div class="col-md-3">
                    <div class="form-floating overflow-hidden">
                        <x-text-input type="name" name="givenName" class="form-control" id="floatingGivenName" placeholder="Juan" :value="old('givenName')" required autofocus autocomplete="given-name" />
                ...
                <div class="col-md-3">
                    <div class="form-floating overflow-hidden">
                        <x-text-input type="name" name="middleName" class="form-control" id="floatingMiddleName" placeholder="Dela" :value="old('middleName')" required autocomplete="additional-name" />
                ...
                <div class="col-md-3">
                    <div class="form-floating overflow-hidden">
                        <x-text-input type="name" name="suffixName" class="form-control" id="floatingSuffixName" placeholder="Jr" :value="old('suffixName')" required autocomplete="honorific-suffix" />
                ...
                <div class="col-md-6">
                    <div class="form-floating overflow-hidden">
                        <x-text-input type="tel" name="cpNumber" class="form-control" id="floatingCpNumber" placeholder="XXXXXXXXXXX" required autocomplete="tel" />
                ...
                <div class="col-md-12">
                    <div class="form-floating overflow-hidden">
                        <x-text-input type="text" name="user_code" class="form-control" id="floatingUserCode" placeholder="User code" required />
                        <x-input-label for="floatingUserCode" :value="__('User Code')" />
                    </div>
                </div>
